...
public class BlockingRequest extends SpRequest {

	public BlockingRequest(MethodConfig config, String transactionId, String providerId, String providerName, String msisdn, Date creationDate, String subscriptionId) {
